      ...
      return (
        ...
        <>
          ...
          <div id="wrapper">
                      ...
                      <div className="well well-trans">
                        <div className="wow fadeInRight" data-wow-delay="0.1s">
                          <ul className="lead-list">
                            <li><span className="list"><h2>Introducing SmartViewMD V1.0 available for smart phone, tablet or computer </h2><h5>(running Chrome or FireFox)</h5>SmartView MD is a consolidated web based portal for medical providers to review (monitor and receive automated alerts of) patient vitals shared (via patient smartphones) from disparate selected 3rd party medical devices  (e.g. blood pressure monitor, glucose monitoring, fingertip pulse oximeter, self monitoring blood glucose meter, and peak flow meter to monitor respiratory conditions such as asthma.)</span></li>
                          ...
                          <p className="text-right wow bounceIn" data-wow-delay="0.4s">
                            <a href="#contact" className="btn btn-skin btn-lg shadow-lg">Learn more <i className="fa fa-angle-right" /></a>
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <section id="service" className="home-section bg-gray paddingbot-60">
                  ...
                  <div className="col-lg-8 col-lg-offset-2">
                    <div className="wow fadeInDown" data-wow-delay="0.1s">
                      ...
                      <br></br>
                          ...
                          <h2 className="h-bold">Welch Allyn Home™ Blood Pressure Monitor</h2><img src="img/dummy/img-0.png" height="200px" alt="computer consulting" />
                        <p>Trusted in the doctor’s office, made for the home. Welch Allyn Home Blood Pressure Monitors combine the clinical quality and accuracy you count on from Welch Allyn with simple, one-button operation for fast and comfortable readings from the comfort of home. The free smartphone app lets patients store and track their readings, so they can monitor their progress. The app seamlessly connects to the blood pressure monitor using Bluetooth®4.0 technology. It is no wonder 95% of physicians surveyed would recommend a Welch Allyn blood pressure device over comparably priced options.</p>
                          <br></br>
                          <br></br>
                          <br></br>

                        <h2 className="h-bold">Glucose Monitor</h2><img src="img/dummy/img-1.png" height="200px" alt="computer consulting" />
                        <p>A continuous glucose monitoring system, that checks your readings day and night, and is accurate for insulin dosing.* The small sensor is about the size of two stacked quarters and can be scanned discretely, even through clothing.  You can even scan the sensor with your compatible smartphone. This device is painless to apply and easy to wear. It's also water resistant so you can swim, shower, and exercise with it on.</p>
                          <br></br>
                          <br></br>
                          <br></br>

                          <h2 className="h-bold">Blood Glucose Meter</h2><img src="img/dummy/img-2.png" height="200px" alt="computer consulting" /><p>The glucose meter features integrated wireless capability, TRIPLE SENSE TECHNOLOGY and enhanced event tags to empower the user to make the connection between their personal lifestyle and results. TRIPLE SENSE TECHNOLOGY automatically detects, analyzes and corrects variables in each blood sample to ensure proven accuracy and confidence in testing results.</p>
                          <br></br>
                          <br></br>
                          <br></br>
            ...
            <section id="service" className="home-section paddingbot-60">
              <div className="container">
                <div className="row">
                  <div className="col-lg-8 col-lg-offset-2">
                    <div className="wow fadeInUp" data-wow-delay="0">
                      <div className="section-heading text-center">
                        <h2 className="h-bold">Our Infrastructure Support Services</h2>
                        <br />
                        <br></br>
                        <br></br>
                      </div>		
                ...
                <div className="row">
                  ...
                  <div className="col-sm-3 col-md-3">
                    <div className="wow fadeInRight" data-wow-delay="0">
